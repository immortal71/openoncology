    ...
    <Link href="/" className="logo-dna-wrap flex items-center gap-2">
      <div className="relative w-6 h-6 shrink-0" style={{ perspective: "80px" }}>
        ...
        >
          ...
          <line x1="10.5" y1="4.5"  x2="13.5" y2="4.5"  stroke="#ffffff" strokeWidth="0.75" strokeOpacity="0.4" />
          <line x1="8.5"  y1="9"    x2="15.5" y2="9"    stroke="#ffffff" strokeWidth="0.75" strokeOpacity="0.65" />
          <line x1="8.5"  y1="14"   x2="15.5" y2="14"   stroke="#ffffff" strokeWidth="0.75" strokeOpacity="0.65" />
          <line x1="10.5" y1="19"   x2="13.5" y2="19"   stroke="#ffffff" strokeWidth="0.75" strokeOpacity="0.4" />
          {/* Strand A — S-curve */}
          <path
