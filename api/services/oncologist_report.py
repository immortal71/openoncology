...
ONCOLOGIST_DISCLAIMER = (
    ...
    "  • Precision@3 ≈ 0.747       (correct drug in top-3, 74.7% of the time)\n"
    "  • Hit@3 ≈ 1.00              (at least one correct drug in top-3, 100%)\n"
    "  • False positive rate on VUS / no-target cases: 0 (8/8 negative controls correct)\n"
